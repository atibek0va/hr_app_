...
public class NewQuestionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void setAnimation(){
        ...
        inputQuestion.setAnimation(from_bottom);
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.btnSubmit){
            saveInfo();
            startActivity(new Intent(NewQuestionActivity.this, MainPageActivity.class));
    ...
    public void saveInfo(){
        ...
        Question question = new Question(uquestion, udate, user);

        myRef.child("questions").child(question.getDate()).setValue(question);
    }
}